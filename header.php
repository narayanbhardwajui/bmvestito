                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-9">
                                <div class="top-info-wrap text-right">
                                    <ul class="top-info">
                                        <li>Mon - Sun : 9am to 9pm </li>
                                        <li><a href="#">+91-8826116007</a></li>
                                        <li><a href="#">info@bmvestito.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-2 col-md-4 col-5">
                    <div class="logo-area">
                        <a href="index.html"><img src="assets/images/logo/logo.png" alt="" width="140px"></a>
                    </div>
                </div>
